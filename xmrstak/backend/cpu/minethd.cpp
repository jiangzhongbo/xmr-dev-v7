...
minethd::cn_hash_fun_multi minethd::func_multi_selector(size_t N, bool bHaveAes, bool bNoPrefetch, xmrstak_algo algo)
{
	...
	static const cn_hash_fun_multi func_table[] = {
		...
		cryptonight_ten_hash<cryptonight_monero, false, false>,
		cryptonight_ten_hash<cryptonight_monero, true, false>,
		cryptonight_ten_hash<cryptonight_monero, false, true>,
		cryptonight_ten_hash<cryptonight_monero, true, true>,
		...
		cryptonight_ten_hash<cryptonight_lite, false, false>,
		cryptonight_ten_hash<cryptonight_lite, true, false>,
		cryptonight_ten_hash<cryptonight_lite, false, true>,
		cryptonight_ten_hash<cryptonight_lite, true, true>,
		...
		cryptonight_ten_hash<cryptonight, false, false>,
		cryptonight_ten_hash<cryptonight, true, false>,
		cryptonight_ten_hash<cryptonight, false, true>,
		cryptonight_ten_hash<cryptonight, true, true>,
		...
		cryptonight_ten_hash<cryptonight_heavy, false, false>,
		cryptonight_ten_hash<cryptonight_heavy, true, false>,
		cryptonight_ten_hash<cryptonight_heavy, false, true>,
		cryptonight_ten_hash<cryptonight_heavy, true, true>,
		...
		cryptonight_ten_hash<cryptonight_aeon, false, false>,
		cryptonight_ten_hash<cryptonight_aeon, true, false>,
		cryptonight_ten_hash<cryptonight_aeon, false, true>,
		cryptonight_ten_hash<cryptonight_aeon, true, true>,
		...
		cryptonight_ten_hash<cryptonight_ipbc, false, false>,
		cryptonight_ten_hash<cryptonight_ipbc, true, false>,
		cryptonight_ten_hash<cryptonight_ipbc, false, true>,
		cryptonight_ten_hash<cryptonight_ipbc, true, true>
	};
